...
class PPC_system_info {
	...
	static function system_info() {
		...
		<div class="wrap">
			<h2><?php _e( 'System Information', 'post-pay-counter' ) ?></h2>
			<form action="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=ppc-system-info&noheader=true' ), 'ppc_download_sysinfo' ) ); ?>" method="post" dir="ltr">
				<textarea readonly="readonly" onclick="this.focus();this.select()" style="font-family: monospace; width: 700px; height: 500px;" name="ppc-sysinfo" title="<?php _e( 'To copy the system info, click below then press Ctrl + C (PC) or Cmd + C (Mac).', 'edd' ); ?>">
### Begin System Info ###
