...
* Extend with your own custom implementation through hooks, filters and special API features ([learn more](http://www.thecrowned.org/add-custom-payment-types-post-pay-counter-stats).
