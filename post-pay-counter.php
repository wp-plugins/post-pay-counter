    ...
    function post_pay_counter_options() {
        ...
        if( isset( $_GET['delete'] ) AND $vaporized_userdata = get_userdata( (int) $_GET['delete'] ) AND $current_user->user_level >= 8 ) {
            ...
            if( is_object( post_pay_counter_functions_class::get_settings( $_GET['delete'] ) ) ) {
                $wpdb->query( 'DELETE FROM '.self::$post_pay_counter_db_table.' WHERE userID = '.$_GET['delete'] );
        ...
        //Stats countings and dates update
            ...
            <div class="updated">
				<p>Looking for brilliant beta testers for the new soon-coming major release. <a href="http://www.thecrowned.org/post-pay-counter-beta-tester-request" title="Join beta test">Join and get a 25% discount on the final PRO version!</a></p>
			</div>
